...
//		notExistBTProject(btProjectName);
	...
	public boolean addRecipient(RecipientDTO newRecipient) throws SQLException, ExistException {
		RecipientDTO recipient = RecipientDAO.getRecipient(newRecipient.getId());
		if(recipient == null) {
			return RecipientDAO.addRecipient(newRecipient);
		}else {
			throw new ExistException("이미 있는 수혈자 입니다.");
		}
	}
